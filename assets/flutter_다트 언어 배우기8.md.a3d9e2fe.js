import{_ as a,c as l,a as s,b as p,t as o,d as e,o as t}from"./app.ff46b2ef.js";const m=JSON.parse('{"title":"다트 언어 배우기8 - 오버라이딩","description":"","frontmatter":{"title":"다트 언어 배우기8 - 오버라이딩"},"headers":[],"relativePath":"flutter/다트 언어 배우기8.md","lastUpdated":null}'),c={name:"flutter/다트 언어 배우기8.md"},r={id:"frontmatter-title",tabindex:"-1"},D=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),A=e(`<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">void </span><span style="color:#82AAFF;">main</span><span style="color:#89DDFF;">()</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
