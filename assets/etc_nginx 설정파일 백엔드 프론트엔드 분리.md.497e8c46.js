import{_ as a,c as l,a as s,b as p,t as o,d as e,o as c}from"./app.ff46b2ef.js";const t="/assets/2023-01-26-01.fa13a8ab.png",f=JSON.parse('{"title":"nginx 설정파일 백엔드 프론트엔드 분리","description":"","frontmatter":{"title":"nginx 설정파일 백엔드 프론트엔드 분리"},"headers":[],"relativePath":"etc/nginx 설정파일 백엔드 프론트엔드 분리.md","lastUpdated":null}'),r={name:"etc/nginx 설정파일 백엔드 프론트엔드 분리.md"},C={id:"frontmatter-title",tabindex:"-1"},y=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),D=e(`<p>아래 설정 파일은 frontend 와 backend 위주로 폴더 분리 해야된다.</p><p>소스코드</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">server</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">{</span></span>
