import{_ as n,c as l,a as s,b as p,t as e,d as o,o as t}from"./app.ff46b2ef.js";const h=JSON.parse('{"title":"다트 언어 배우기9 - 인터페이스","description":"","frontmatter":{"title":"다트 언어 배우기9 - 인터페이스"},"headers":[{"level":2,"title":"느낀점 :","slug":"느낀점","link":"#느낀점","children":[]}],"relativePath":"flutter/다트 언어 배우기9.md","lastUpdated":null}'),c={name:"flutter/다트 언어 배우기9.md"},r={id:"frontmatter-title",tabindex:"-1"},D=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),y=o(`<div class="info custom-block"><p class="custom-block-title">INFO</p><p>인터페이스는</p><p>특수한 구조를 설계만 하고 이런 형태로 받아서 사용한다고 생각 하면된다.</p></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">void </span><span style="color:#82AAFF;">main</span><span style="color:#89DDFF;">()</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
