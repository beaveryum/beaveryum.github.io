import{_ as a,c as l,a as s,b as p,t as o,d as e,o as t}from"./app.86428379.js";const f=JSON.parse('{"title":"엔진엑스 설정 (최종 원본)","description":"","frontmatter":{"title":"엔진엑스 설정 (최종 원본)"},"headers":[],"relativePath":"etc/엔진엑스 설정 (최종 원본).md","lastUpdated":1674745074000}'),c={name:"etc/엔진엑스 설정 (최종 원본).md"},r={id:"frontmatter-title",tabindex:"-1"},C=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),y=e(`<p>참고해서 응용하면 된다.</p><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">user</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">nginx</span><span style="color:#89DDFF;">;</span></span>
