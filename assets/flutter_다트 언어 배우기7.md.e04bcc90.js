import{_ as a,c as p,a as s,b as l,t as o,d as e,o as t}from"./app.ff46b2ef.js";const g=JSON.parse('{"title":"다트 언어 배우기7 - 클래스 oop","description":"","frontmatter":{"title":"다트 언어 배우기7 - 클래스 oop"},"headers":[],"relativePath":"flutter/다트 언어 배우기7.md","lastUpdated":null}'),c={name:"flutter/다트 언어 배우기7.md"},r={id:"frontmatter-title",tabindex:"-1"},D=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),y=e(`<p>클래스 oop</p><p>클래스 명은 첫자는 무조건 대문자</p><p>인스턴스화</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">void </span><span style="color:#82AAFF;">main</span><span style="color:#89DDFF;">()</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
